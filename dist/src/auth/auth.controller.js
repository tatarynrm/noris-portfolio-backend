...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Return JWT Token' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 302, description: 'Redirect to frontend with JWT Token' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return confirmation message' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
